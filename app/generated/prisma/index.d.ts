...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "advantages" | "certificates"
    ...
    model: {
      Advantages: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.AdvantagesFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.AdvantagesAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type AdvantagesOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "image", ExtArgs["result"]["advantages"]>
  ...
  export interface AdvantagesDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Advantages that matches the filter.
     * @param {AdvantagesFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const advantages = await prisma.advantages.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: AdvantagesFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Advantages.
     * @param {AdvantagesAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const advantages = await prisma.advantages.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: AdvantagesAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface AdvantagesFieldRefs {
    ...
    readonly title: FieldRef<"Advantages", 'String'>
    readonly image: FieldRef<"Advantages", 'String'>
  }
   ...
   * Advantages findRaw
   */
  export type AdvantagesFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * Advantages aggregateRaw
   */
  export type AdvantagesAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type CertificatesOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "image" | "link", ExtArgs["result"]["certificates"]>
  ...
  export type AdvantagesWhereInput = {
    ...
    id?: StringFilter<"Advantages"> | string
    title?: StringFilter<"Advantages"> | string
    image?: StringFilter<"Advantages"> | string
  }
  ...
  export type AdvantagesScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"Advantages"> | string
    title?: StringWithAggregatesFilter<"Advantages"> | string
    image?: StringWithAggregatesFilter<"Advantages"> | string
  }
  ...
  export type CertificatesWhereInput = {
    ...
    image?: StringFilter<"Certificates"> | string
    link?: StringFilter<"Certificates"> | string
  }
  ...
  export type CertificatesScalarWhereWithAggregatesInput = {
    ...
    image?: StringWithAggregatesFilter<"Certificates"> | string
    link?: StringWithAggregatesFilter<"Certificates"> | string
  }
